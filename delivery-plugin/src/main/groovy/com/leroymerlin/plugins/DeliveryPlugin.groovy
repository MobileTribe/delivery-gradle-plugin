...
public class DeliveryPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        project.afterEvaluate {
            ...
            project.task("initReleaseBranch", description: "Creates or switch to the release branch") << scmAdapter.&initReleaseBranch
            project.task("prepareReleaseFiles", description: "Prepare project file for release", dependsOn: "initReleaseBranch") << this.&changeAndCommitReleaseVersion
