...
:sourcedir: ../../delivery-plugin/src/test/groovy

[source,groovy]
----
include::{sourcedir}/com/leroymerlin/plugins/test/integration/AndroidDeliveryTest.groovy[]
----
...
* *VERSION_ID_ARG* // project version id
* *VERSION_ARG* // project version
* *GROUP_ARG* // project group
* *ROJECT_NAME_ARG* // project name
* *ionicBuild* // type of ionic project you want to build