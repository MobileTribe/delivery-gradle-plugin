...
delivery {
    ...
    // Define modules that their Install and Upload tasks will be linked with their parents
    linkedSubModules = []
...
link:{htmlPath}delivery-doc/html/Flows.html[See preconfigured Flows]
