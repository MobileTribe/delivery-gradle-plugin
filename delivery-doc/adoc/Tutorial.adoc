...
Flows and signingProperties DSL is base on http://mrhaki.blogspot.fr/2016/02/gradle-goodness-create-objects-with-dsl.html[Gradle NamedDomainObjectContainer].
...
You can externalize criticals informations using a https://en.wikipedia.org/wiki/.properties[properties file]
...
IMPORTANT: You should consider not to put keystore and credential inside of your repository.
...
If your project doesn't answer to the Delivery's supported configurations (iOS, Android, Ionic, Java, Groovy), you can define your own configurator.
