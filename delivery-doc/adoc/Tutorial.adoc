...
NOTE: Delivery now support Android projects using Android plugin 2 and 3
...
You can link *Install* task and *Upload* task from childs modules with parent module by using *enableAllSubModules(String[] projectNameIgnored)* or *subModules(String[] projectName)*
...
IMPORTANT: You need to apply Delivery on all modules you want to use with Delivery
