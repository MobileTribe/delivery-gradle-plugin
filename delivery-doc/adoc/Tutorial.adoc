...
SigningConfiguration allows you to configure artifact signature. +
...
IMPORTANT: You should considere not to put keystore and credential inside of your repository.
